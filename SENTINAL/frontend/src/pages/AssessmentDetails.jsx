        ...
        <div className="cyber-card" style={{ display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '16px' }}>
            <div>
              ...
              <div style={{ fontSize: '28px', fontWeight: '800', color: '#ff3366', fontFamily: 'var(--font-mono)' }}>{assessment.critical_count}</div>
            </div>
            <div>
              <div style={{ fontSize: '11px', color: '#64748b', textTransform: 'uppercase' }}>High</div>
              <div style={{ fontSize: '28px', fontWeight: '800', color: '#f59e0b', fontFamily: 'var(--font-mono)' }}>{assessment.high_count}</div>
            </div>
            <div>
              <div style={{ fontSize: '11px', color: '#64748b', textTransform: 'uppercase' }}>Medium</div>
              <div style={{ fontSize: '28px', fontWeight: '800', color: '#eab308', fontFamily: 'var(--font-mono)' }}>{assessment.medium_count}</div>
            </div>
            <div>
              <div style={{ fontSize: '11px', color: '#64748b', textTransform: 'uppercase' }}>Low / Info</div>
              <div style={{ fontSize: '28px', fontWeight: '800', color: '#38bdf8', fontFamily: 'var(--font-mono)' }}>{assessment.low_count + assessment.info_count}</div>
            </div>
          </div>
