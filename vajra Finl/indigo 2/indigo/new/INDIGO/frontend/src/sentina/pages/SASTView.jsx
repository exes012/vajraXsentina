...
export function SASTView() {
  const [findings, setFindings] = useState(() => filterModuleFindings('sast', dashboardService.getInitialFindings()));
  const [selectedRating, setSelectedRating] = useState('ALL');
  const [searchQuery, setSearchQuery] = useState('');
  const [selectedFinding, setSelectedFinding] = useState(() => {
    const init = filterModuleFindings('sast', dashboardService.getInitialFindings());
