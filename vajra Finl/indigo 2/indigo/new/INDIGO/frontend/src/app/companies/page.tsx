      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <main className="flex-1 overflow-y-auto p-3.5 sm:p-4 w-full max-w-[1440px] mx-auto space-y-3.5">
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-3 mb-4">
            <div>
              <h1 className="text-xl sm:text-2xl font-black text-white uppercase tracking-wider text-glow flex items-center gap-2.5">
                <Building2 className="w-6 h-6 text-[#ff1744]" /> Enterprise Target Scope & EASM
              </h1>
            ...
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-[#ff1744] via-[#be123c] to-[#880815] text-white rounded-xl hover:brightness-110 transition-all shadow-[0_0_14px_rgba(255,23,68,0.5)] border border-white/20 font-black text-xs uppercase tracking-wider"
            >
          ...
          <div className="space-y-3 mb-4">
            <div className="flex flex-wrap items-center justify-between gap-3">
              {/* Filter Tabs */}
              <div className="flex items-center gap-1.5 p-1 bg-[#060108] border-2 border-[#360a25] rounded-xl flex-wrap">
                <button
                  onClick={() => setActiveTab('all')}
                  className={`px-3 py-1 rounded-lg text-xs font-black uppercase transition-all flex items-center gap-1.5 ${
                    activeTab === 'all'
                ...
                >
                  ...
                  All Scope
                  <span className={`text-[10px] px-1.5 py-0.2 rounded-full font-mono font-bold ${activeTab === 'all' ? 'bg-white/20 text-white' : 'bg-[#030004] text-[#ff1744] border border-red-500/30'}`}>
                    {companies.length}
                  </span>
                </button>
                ...
                >
                  ...
                  Global Core
                  <span className={`text-[10px] px-1.5 py-0.2 rounded-full font-mono font-bold ${activeTab === 'global' ? 'bg-white/20 text-white' : 'bg-[#030004] text-[#00f2fe] border border-cyan-500/30'}`}>
                    {globalCount}
                  </span>
                </button>
                ...
                {isAdmin && (
                  ...
                  >
                    ...
                    User Monitored
                    <span className={`text-[10px] px-1.5 py-0.2 rounded-full font-mono font-bold ${activeTab === 'users' ? 'bg-white/20 text-white' : 'bg-[#030004] text-[#fbbf24] border border-amber-500/30'}`}>
                      {userAddedCount}
                    </span>
                  </button>
                )}
                ...
                >
                  ...
                  My Assets
                  <span className={`text-[10px] px-1.5 py-0.2 rounded-full font-mono font-bold ${activeTab === 'my' ? 'bg-white/20 text-white' : 'bg-[#030004] text-[#a855f7] border border-purple-500/30'}`}>
                    {myCount}
                  </span>
                </button>
              </div>
