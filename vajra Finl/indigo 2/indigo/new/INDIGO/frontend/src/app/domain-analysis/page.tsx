    ...
    <div className="flex min-h-screen bg-[#030004] text-white">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <main className="flex-1 overflow-hidden relative">
          ...
          {!iframeLoaded && (
            <div className="absolute inset-0 flex items-center justify-center bg-[#030004] z-10 transition-opacity duration-300">
              <div className="flex flex-col items-center gap-4">
                <div className="w-10 h-10 border-3 border-[#ff1744] border-t-transparent rounded-full animate-spin" />
                <p className="text-[#a1a1aa] text-sm font-medium">Initializing VAJRA Domain Pulse Telemetry Engine...</p>
              </div>
            </div>
          )}
          {/* 
...
export default function DomainAnalysisPage() {
  return (
    <Suspense fallback={
      <div className="flex min-h-screen bg-[#030004] items-center justify-center">
        <div className="w-8 h-8 border-3 border-[#ff1744] border-t-transparent rounded-full animate-spin" />
      </div>
    }>
