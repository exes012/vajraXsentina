          ...
          <div className="bg-gradient-to-r from-[#0d0111] via-[#060108] to-[#0d0111] border-2 border-[#360a25] rounded-2xl p-4 sm:p-5 shadow-[0_0_25px_rgba(255,23,68,0.15)] flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            <div>
              <div className="flex items-center gap-2.5">
                <div className="w-10 h-10 rounded-xl bg-red-950/60 border border-red-500/50 flex items-center justify-center shadow-[0_0_12px_rgba(255,23,68,0.4)]">
                  <Building2 className="w-5 h-5 text-[#ff1744]" />
                </div>
                <div>
            ...
            <div className="flex items-center gap-3">
              <div className="bg-[#030004] border border-[#360a25] px-3.5 py-1.5 rounded-xl text-center">
                <span className="text-[9px] text-zinc-400 uppercase font-black tracking-wider block">Monitored Sectors</span>
              ...
              <div className="bg-[#030004] border border-red-500/40 px-3.5 py-1.5 rounded-xl text-center shadow-[0_0_10px_rgba(255,23,68,0.2)]">
                <span className="text-[9px] text-[#ff1744] uppercase font-black tracking-wider block">Highest Targeted</span>
                <span className="text-base font-black text-[#ff1744] font-mono">Healthcare (28.5%)</span>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row gap-3 items-stretch md:items-center justify-between bg-[#060108] border-2 border-[#360a25] p-3 rounded-xl">
            ...
            <div className="flex items-center gap-2 flex-wrap">
              <div className="flex items-center gap-1 text-[11px] font-mono text-zinc-400">
                <Filter className="w-3.5 h-3.5 text-zinc-500" /> Risk Level:
              </div>
                  ...
                  <div>
                      ...
                      <div className="flex items-center gap-2.5">
                        ...
                        <div>
                          ...
                          <div className="flex items-center gap-1.5 mt-0.5">
                            <span className={`text-[8.5px] font-black uppercase px-2 py-0.5 rounded-full border font-mono ${getRiskBadge(industry.risk_level)}`}>
                    ...
                    <div className="space-y-1.5 pt-2.5 border-t border-[#360a25]">
                      <div className="flex items-center justify-between text-xs">
                        <span className="text-zinc-400 font-medium text-[11px] flex items-center gap-1">
                          <TrendingUp className="w-3 h-3 text-[#ff1744]" /> Attack Share
                        </span>
                    ...
                    {cves.length > 0 && (
                      <div className="mt-2.5 pt-2 border-t border-[#200516] flex items-center gap-1.5 flex-wrap">
                        ...
                        {cves.length > 2 && (
                          <span className="text-[8.5px] font-mono text-zinc-500">+{cves.length - 2} CVEs</span>
                        )}
                      </div>
                    )}
                  </div>
                ...
                <div className="flex items-start gap-3.5">
                  ...
                  <div>
                    <div className="flex items-center gap-2.5 flex-wrap">
                      <h2 className="text-xl font-black text-white uppercase tracking-wider">{selectedIndustry.name}</h2>
                      <span className={`text-[9.5px] font-black uppercase px-2.5 py-0.5 rounded-full border font-mono ${getRiskBadge(selectedIndustry.risk_level)}`}>
                        {selectedIndustry.risk_level || 'CRITICAL'} RISK
                      </span>
                    </div>

                    <div className="flex items-center gap-2 mt-1 text-xs font-mono text-zinc-300">
                      <span>Global Telemetry: <strong className="text-[#ff1744] font-black">{selectedIndustry.attack_percentage || 18}%</strong></span>
                      <span>•</span>
              ...
              <div className="p-5 sm:p-6 space-y-6 flex-1">
                  ...
                  <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="space-y-5">
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                      <div className="bg-[#030004] border border-[#360a25] rounded-xl p-3">
                        <span className="text-[10px] text-zinc-400 font-black uppercase">Primary Ingress Vector</span>
                        <p className="text-xs font-bold text-white font-mono mt-0.5 truncate">
                          {selectedIndustry.primary_vector || 'Double Extortion'}
                        </p>
                      </div>
                      <div className="bg-[#030004] border border-[#360a25] rounded-xl p-3">
                        <span className="text-[10px] text-zinc-400 font-black uppercase">Active Campaigns</span>
                        <p className="text-sm font-bold text-[#ff1744] font-mono mt-0.5">
                          {selectedIndustry.campaigns_count || 24} Major Operations
                        </p>
                      </div>
                      <div className="bg-[#030004] border border-[#360a25] rounded-xl p-3">
                        <span className="text-[10px] text-zinc-400 font-black uppercase">Telemetry Volume</span>
                        <p className="text-sm font-black text-white font-mono mt-0.5">
                          {selectedIndustry.attack_percentage || 18}% Global Share
                        </p>
                      </div>
                      <div className="bg-[#030004] border border-[#360a25] rounded-xl p-3">
                        <span className="text-[10px] text-zinc-400 font-black uppercase">Attack Growth Trend</span>
                        <p className="text-sm font-black text-red-400 font-mono mt-0.5">
                    ...
                    <div>
                      <h3 className="text-xs font-black uppercase tracking-widest text-zinc-400 mb-2 flex items-center gap-1.5">
                        <FileText className="w-4 h-4 text-[#ff1744]" /> Executive Sector Threat Profile
                      </h3>
                      <div className="bg-[#030004] border border-[#360a25] rounded-xl p-4 text-xs text-zinc-200 leading-relaxed">
                    ...
                    {selectedIndustry.threat_landscape_analysis && (
                      <div>
                        ...
                        <div className="bg-[#030004] border border-[#360a25] rounded-xl p-4 text-xs text-zinc-300 leading-relaxed font-medium">
                          {selectedIndustry.threat_landscape_analysis}
                        </div>
                      </div>
                    )}
                    ...
                    {selectedIndustry.downtime_cost_per_hour && (
                      <div>
                        ...
                        <div className="bg-[#030004] border border-emerald-500/30 rounded-xl p-4 text-xs text-emerald-200 font-mono">
                          {selectedIndustry.downtime_cost_per_hour}
                        </div>
                      </div>
                    )}
                    ...
                    <div>
                      ...
                      <div className="flex flex-wrap gap-2 bg-[#030004] border border-[#360a25] p-3.5 rounded-xl">
                        {(selectedIndustry.top_adversaries || []).map((adv, i) => (
                          <span key={i} className="text-xs font-mono font-bold px-3 py-1 bg-red-950/40 text-red-300 border border-red-500/40 rounded-lg">
                            {adv}
                          </span>
                        ))}
                      </div>
                ...
                {activeTab === 'VECTORS' && (
                  <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="space-y-5">
                    ...
                    <div>
                      <h3 className="text-xs font-black uppercase tracking-widest text-zinc-400 mb-2 flex items-center gap-1.5">
                        <Zap className="w-4 h-4 text-[#ff1744]" /> Primary Sector Attack Vectors & Ingress Mechanics
                      </h3>
                      ...
                      <div className="space-y-2.5">
                        {(selectedIndustry.primary_threat_vectors || [
                          ...
                          <div key={i} className="bg-[#030004] border border-[#360a25] rounded-xl p-3.5 flex items-center gap-3 hover:border-red-500/40 transition-colors">
                            <span className="w-6 h-6 rounded-lg bg-red-950 text-[#ff1744] border border-red-500/40 flex items-center justify-center font-mono text-xs font-black flex-shrink-0">
                              0{i + 1}
                            </span>
                            <span className="text-xs text-zinc-200 font-bold">{vec}</span>
                          </div>
                        ))}
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      <div className="bg-[#030004] border border-[#360a25] rounded-xl p-4 text-xs text-amber-200/90 leading-relaxed">
                ...
                {activeTab === 'CASES' && (
                  <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="space-y-4">
                    <div>
                      <h3 className="text-xs font-black uppercase tracking-widest text-zinc-400 mb-2 flex items-center gap-1.5">
                        <FileText className="w-4 h-4 text-[#ff1744]" /> Real-World Breach Case Studies & Root-Cause Failure Analyses
                      </h3>
                      <p className="text-xs text-zinc-400 mb-3">
                    ...
                    {selectedIndustry.real_world_case_studies && selectedIndustry.real_world_case_studies.length > 0 ? (
                        ...
                        {selectedIndustry.real_world_case_studies.map((cs: CaseStudy, i: number) => (
                          <div key={i} className="bg-[#030004] border border-[#360a25] rounded-xl p-4 hover:border-red-500/50 transition-colors space-y-2">
                            <div className="flex items-center justify-between gap-2 flex-wrap">
                              <div>
                                <h4 className="text-xs font-black text-white">{cs.title}</h4>
                      ...
                      <div className="bg-[#030004] border border-[#360a25] rounded-xl p-4 text-xs text-zinc-300">
                    ...
                    {selectedIndustry.defense_hardening_checklist && selectedIndustry.defense_hardening_checklist.length > 0 ? (
                      <div className="space-y-3">
                        {selectedIndustry.defense_hardening_checklist.map((item: DefenseControl, i: number) => (
                          <div key={i} className="bg-[#030004] border border-[#360a25] rounded-xl p-4 hover:border-emerald-500/40 transition-colors space-y-2">
                            <div className="flex items-center justify-between gap-2 flex-wrap">
                            ...
                            <p className="text-xs text-zinc-400 font-mono bg-[#060108] p-2 rounded border border-[#200516]">
                      ...
                      <div className="space-y-2">
                        {(selectedIndustry.recommended_defenses || []).map((def, i) => (
                          <div key={i} className="bg-[#030004] border border-[#360a25] rounded-xl p-3.5 flex items-start gap-2.5 text-xs text-emerald-300">
                  ...
                  <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="space-y-5">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                      {(selectedIndustry.regulatory_frameworks || ['ISO/IEC 27001', 'NIST CSF', 'NIS2 Directive', 'GDPR']).map((reg, i) => (
                        <div key={i} className="bg-[#030004] border border-[#360a25] rounded-xl p-4 flex items-center gap-3">
                          ...
                          <div>
                            ...
                            <span className="text-[10px] text-zinc-400 block mt-0.5">Mandatory Compliance Baseline</span>
                          </div>
                        </div>
                      ))}
                    </div>
