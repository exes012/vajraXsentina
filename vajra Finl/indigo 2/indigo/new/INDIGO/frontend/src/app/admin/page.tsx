        ...
        <main className="flex-1 overflow-y-auto p-3.5 sm:p-4 w-full max-w-[1440px] mx-auto space-y-3.5">
          ...
          >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
              <div className="bg-[#060108] border-2 border-[#360a25] rounded-xl p-3.5 hover:border-[#ff1744] transition-all shadow-[0_8px_32px_0_rgba(0,0,0,0.95)]">
                <div className="flex items-center justify-between mb-1.5">
                  <span className="text-[10.5px] font-black text-zinc-400 uppercase tracking-wider">Monitored Domains</span>
                  <div className="p-1.5 rounded-lg bg-red-950/40 border border-red-500/30 text-[#ff1744]">
                    <Building2 className="w-4 h-4" />
                  </div>
                </div>
                <div className="text-2xl font-black text-white font-mono text-glow">{companies.length}</div>
                <div className="text-[10px] text-zinc-400 mt-1 flex items-center gap-2 font-mono">
                  <span className="text-[#00f2fe] font-bold">{globalCount} Global</span>
                  <span>•</span>
                  <span className="text-[#a855f7] font-bold">{userCount} User Added</span>
                </div>
              </div>

              <div className="bg-[#060108] border-2 border-[#360a25] rounded-xl p-3.5 hover:border-[#00ff88] transition-all shadow-[0_8px_32px_0_rgba(0,0,0,0.95)]">
                <div className="flex items-center justify-between mb-1.5">
                  <span className="text-[10.5px] font-black text-zinc-400 uppercase tracking-wider">Threat Feed Status</span>
                  <div className="p-1.5 rounded-lg bg-emerald-950/40 border border-emerald-500/30 text-[#00ff88]">
                    <Radio className="w-4 h-4 animate-pulse" />
                  </div>
                </div>
                <div className="text-2xl font-black text-[#00ff88] font-mono text-glow-low">5 ACTIVE</div>
                <div className="text-[10px] text-zinc-400 mt-1 font-mono">OTX, GDELT, VT, NVD, Ransomware</div>
              </div>

              <div className="bg-[#060108] border-2 border-[#360a25] rounded-xl p-3.5 hover:border-[#00f2fe] transition-all shadow-[0_8px_32px_0_rgba(0,0,0,0.95)]">
                <div className="flex items-center justify-between mb-1.5">
                  <span className="text-[10.5px] font-black text-zinc-400 uppercase tracking-wider">Active Users</span>
                  <div className="p-1.5 rounded-lg bg-cyan-950/40 border border-cyan-500/30 text-[#00f2fe]">
                    <Users className="w-4 h-4" />
                  </div>
                </div>
                <div className="text-2xl font-black text-white font-mono">{stats?.active_users || 3}</div>
                <div className="text-[10px] text-zinc-400 mt-1">Role-Based Access Control Enforced</div>
              </div>

              <div className="bg-[#060108] border-2 border-[#360a25] rounded-xl p-3.5 hover:border-[#a855f7] transition-all shadow-[0_8px_32px_0_rgba(0,0,0,0.95)]">
                <div className="flex items-center justify-between mb-1.5">
                  <span className="text-[10.5px] font-black text-zinc-400 uppercase tracking-wider">Engine Health</span>
                  <div className="p-1.5 rounded-lg bg-purple-950/40 border border-purple-500/30 text-[#a855f7]">
                    <Activity className="w-4 h-4" />
                  </div>
                </div>
                <div className="text-2xl font-black text-[#a855f7] font-mono text-glow-purple">100% OPERATIONAL</div>
                <div className="text-[10px] text-zinc-400 mt-1 font-mono">Sub-150ms average sensor latency</div>
              </div>
            </div>
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-3">
                  <div>
                    <h2 className="text-sm font-black uppercase tracking-wider text-white flex items-center gap-2">
                      <Building2 className="w-4 h-4 text-[#ff1744]" />
                  ...
                  <div className="flex items-center gap-2 flex-wrap">
                    {/* Scope filter */}
                    <div className="flex items-center gap-1 bg-[#030004] border-2 border-[#360a25] rounded-lg p-0.5">
                      <button
                        onClick={() => setFilterScope('all')}
                        className={`px-2.5 py-1 text-xs font-black uppercase rounded transition-colors ${
                          filterScope === 'all' ? 'bg-[#ff1744] text-white shadow-[0_0_10px_rgba(255,23,68,0.5)]' : 'text-zinc-400 hover:text-white'
                        }`}
                      >
                      ...
                      <button
                        ...
                        className={`px-2.5 py-1 text-xs font-black uppercase rounded transition-colors ${
                          filterScope === 'global' ? 'bg-[#ff1744] text-white shadow-[0_0_10px_rgba(255,23,68,0.5)]' : 'text-zinc-400 hover:text-white'
                        }`}
                      >
                        Global ({globalCount})
                      </button>
                      <button
                        ...
                        className={`px-2.5 py-1 text-xs font-black uppercase rounded transition-colors ${
                          filterScope === 'users' ? 'bg-[#ff1744] text-white shadow-[0_0_10px_rgba(255,23,68,0.5)]' : 'text-zinc-400 hover:text-white'
                        }`}
                      >
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="pl-8 pr-3 py-1 bg-[#030004] border-2 border-[#360a25] rounded-lg text-xs text-white placeholder:text-zinc-600 focus:outline-none focus:border-[#ff1744] w-56 font-mono"
                      />
                    </div>
                  </div>
                </div>
