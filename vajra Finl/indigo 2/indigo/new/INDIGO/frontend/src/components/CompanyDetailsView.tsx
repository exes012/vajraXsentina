...
export default function CompanyDetailsView() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-[#030004] text-white">
      <Navbar />
      ...
      <div className="flex-1 max-w-7xl w-full mx-auto p-3.5 sm:p-4 lg:p-6 space-y-4">
        ...
        <div className="flex items-center justify-between gap-4">
          <button
            onClick={() => router.push('/companies')}
            className="flex items-center gap-2 text-xs font-black uppercase text-zinc-300 hover:text-white transition-colors bg-[#060108] hover:bg-[#0e0212] px-3 py-1.5 rounded-xl border-2 border-[#360a25] hover:border-[#ff1744]"
          >
            <ArrowLeft className="w-4 h-4 text-[#ff1744]" /> Back to Assets
          </button>

          <div className="flex items-center gap-2 flex-wrap">
            <button
              onClick={() => setShowHistoryModal(true)}
              className="flex items-center gap-2 px-3 py-1.5 bg-[#060108] hover:bg-[#0e0212] border-2 border-[#360a25] text-white rounded-xl text-xs font-black uppercase transition hover:border-[#00f2fe]"
            ...
            <button
              ...
              disabled={analyzing}
              className="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-[#ff1744] via-[#be123c] to-[#880815] text-white rounded-xl text-xs font-black uppercase tracking-wider hover:brightness-110 transition disabled:opacity-50 shadow-[0_0_14px_rgba(255,23,68,0.5)] border border-white/20"
            >
              <RefreshCw className={`w-3.5 h-3.5 ${analyzing ? 'animate-spin text-[#00f2fe]' : ''}`} />
        ...
        <div className="bg-[#060108] border-2 border-[#360a25] rounded-xl p-4 sm:p-5 shadow-[0_8px_32px_0_rgba(0,0,0,0.95)]">
