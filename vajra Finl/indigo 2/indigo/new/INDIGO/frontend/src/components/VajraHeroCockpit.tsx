  ...
  return (
    <div
      style={{
        ...
        borderRadius: '14px',
        padding: '18px 20px',
        boxShadow: '0 12px 40px rgba(0, 0, 0, 0.95), 0 0 20px rgba(255, 23, 68, 0.15)',
        position: 'relative',
        overflow: 'hidden'
      }}
      className="hover:border-[#ff1744] hover:shadow-[0_0_30px_rgba(255,23,68,0.35)] transition-all duration-300"
    >
      ...
      <div
        style={{
          ...
          inset: 0,
          backgroundImage:
            'radial-gradient(circle at 18% 50%, rgba(255, 23, 68, 0.07) 0%, transparent 60%), radial-gradient(circle at 85% 20%, rgba(0, 242, 254, 0.05) 0%, transparent 50%), linear-gradient(to right, rgba(255, 23, 68, 0.015) 1px, transparent 1px), linear-gradient(to bottom, rgba(255, 23, 68, 0.015) 1px, transparent 1px)',
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-5 items-stretch relative z-10">
        ...
        {/* ================================================================= */}
        <div className="lg:col-span-5 flex flex-col items-center justify-between p-3 border-b lg:border-b-0 lg:border-r-2 border-[#28081c]/80 relative bg-black/40 rounded-xl">
          ...
          <div className="w-full flex items-center justify-between mb-2">
            <div className="flex items-center gap-2">
              <span className="flex h-2.5 w-2.5 relative">
                ...
                <span className="relative inline-flex rounded-full h-2.5 w-2.5 bg-[#ff1744] shadow-[0_0_8px_#ff1744]"></span>
              </span>
              <span className="text-[12px] font-black uppercase tracking-widest text-white font-mono flex items-center gap-1.5">
                <Crosshair size={14} className="text-[#ff1744] animate-spin" style={{ animationDuration: '8s' }} />
                AI THREAT INTELLIGENCE RADAR
              </span>
            </div>
            <div className="flex items-center gap-1.5">
              <span className={`text-[9.5px] font-mono font-black ${displayScore >= 80 ? 'text-emerald-300 bg-emerald-950/60 border-emerald-500/50 shadow-[0_0_8px_rgba(16,185,129,0.3)]' : displayScore >= 60 ? 'text-amber-300 bg-amber-950/60 border-amber-500/50 shadow-[0_0_8px_rgba(251,191,36,0.3)]' : 'text-red-300 bg-red-950/60 border-red-500/50 shadow-[0_0_8px_rgba(255,23,68,0.3)]'} px-2.5 py-0.5 rounded-md border`}>
                POSTURE: {displayScore >= 80 ? 'OPTIMAL' : displayScore >= 60 ? 'ELEVATED' : 'CRITICAL'} ({displayScore}%)
              </span>
              <span className="text-[9px] font-mono font-black text-[#00ff88] bg-emerald-950/60 border border-emerald-500/50 px-2 py-0.5 rounded-md">
                LIVE
              </span>
            </div>
          </div>
            ...
            >
              <div
                style={{
                  ...
                  boxShadow: '0 0 25px rgba(255, 23, 68, 0.55), inset 0 0 16px rgba(255, 23, 68, 0.25)'
                }}
                className="flex flex-col items-center"
              >
                <div className="flex items-center gap-1.5 mb-0.5">
                  <Flame size={13} color="#ff1744" className="animate-pulse" />
                  <span className="text-[9.5px] font-mono font-black text-[#ff2a4d] uppercase tracking-widest">
                    AI DEFENSE POSTURE
                  </span>
                </div>
                ...
                <div
                  style={{
                    ...
                    lineHeight: 1,
                    letterSpacing: '-0.5px',
                    textShadow: '0 0 18px rgba(255, 23, 68, 0.95), 0 0 32px rgba(255, 23, 68, 0.6)'
                  }}
                ...
                <div
                  style={{
                    padding: '3.5px 12px',
                    borderRadius: '8px',
                    background: displayScore >= 80 ? 'linear-gradient(90deg, #10b981 0%, #059669 100%)' : displayScore >= 60 ? 'linear-gradient(90deg, #f59e0b 0%, #d97706 100%)' : 'linear-gradient(90deg, #ff1744 0%, #be123c 100%)',
                    fontSize: '9.5px',
                    fontWeight: 900,
                    color: '#ffffff',
                    letterSpacing: '1px',
                    boxShadow: `0 0 12px ${displayScore >= 80 ? 'rgba(16, 185, 129, 0.7)' : displayScore >= 60 ? 'rgba(245, 158, 11, 0.7)' : 'rgba(255, 23, 68, 0.7)'}`
                  }}
                ...
                <div className="text-[9px] font-mono font-bold text-zinc-300 mt-2 uppercase tracking-wider flex items-center gap-1">
                  <span>POSTURE DELTA:</span>
                  <span className="text-[#00ff88] font-black">+18.4%</span>
                  <span className="text-zinc-500">vs 24h</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="w-full flex flex-wrap items-center justify-center gap-1.5 my-2">
            {threatPills.map((p, idx) => (
              <div
                ...
                className="hover:border-[#ff1744] hover:shadow-[0_0_8px_rgba(255,23,68,0.3)] transition-all"
              >
                <span
                  style={{
                    width: '4.5px',
                ...
                />
                <span className="text-[8.5px] font-mono font-extrabold text-zinc-300 tracking-wider">
                  {p.label}
                </span>
              </div>
            ))}
          ...
          <div className="w-full flex items-center justify-between mt-2 pt-2 border-t border-[#28081c]/70">
            <div className="flex items-center gap-2">
        ...
        {/* ================================================================= */}
        <div className="lg:col-span-7 flex flex-col justify-between gap-4 bg-black/40 p-4 rounded-xl border border-[#28081c]">
          {/* Header Row */}
          <div className="flex items-center justify-between pb-3 border-b border-[#28081c]/80">
            <div className="flex items-center gap-2.5">
              <Radio className="w-4 h-4 text-[#ff1744] animate-pulse" />
              <h2 className="text-sm font-black uppercase tracking-widest text-white">
                VAJRA TELEMETRY & ATTACK RADAR
              </h2>
            </div>
            <span className="text-[9.5px] font-mono font-black text-[#00f2fe] bg-cyan-950/60 border border-cyan-500/60 px-3 py-1 rounded-full shadow-[0_0_10px_rgba(0,242,254,0.3)]">
              AI COCKPIT ACTIVE
            </span>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5 my-auto">
            {metrics.map((m) => (
              <Link
                ...
                className="hover:border-[#ff1744] hover:shadow-[0_0_24px_rgba(255,23,68,0.35)] hover:-translate-y-0.5 group"
              >
                ...
                <div>
                  <div className="flex items-center justify-between mb-2">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <div className="text-[9.5px] font-black uppercase tracking-wider text-zinc-400">
                          {m.label}
                        </div>
                        <div
                          style={{
                          ...
                          className="font-mono group-hover:text-white transition-colors mt-0.5"
                        >
                          {m.value}
                        </div>
                      </div>
                ...
                <div className="flex items-center justify-between pt-2.5 border-t border-[#28081c]">
                  <div className="text-[10px] font-bold">
                    <span style={{ color: m.color, fontWeight: 900 }} className="mr-1.5 font-mono">
                      {m.delta}
                    </span>
                    <span className="text-zinc-400 text-[9px] font-mono">{m.deltaPeriod}</span>
                  </div>
          ...
          <div
            ...
            className="hover:border-[#ff1744] transition-all"
          >
            <div
              style={{
                position: 'absolute',
                ...
                bottom: 0,
                width: '4px',
                background: 'linear-gradient(180deg, #ff1744 0%, #00f2fe 100%)',
                boxShadow: '0 0 8px #ff1744'
              }}
            />

            <div className="flex items-center gap-3 pl-2">
              <Zap className="w-4 h-4 text-[#ff1744] animate-pulse flex-shrink-0" />
              <div>
                <div className="text-[11px] font-black uppercase tracking-wider text-white flex items-center gap-1.5">
                  THREAT MITIGATION: <span className="text-[#ff1744]">MAXIMUM LOCKDOWN</span>
                </div>
            ...
            <Link
              ...
              prefetch={true}
              style={{
                background: 'linear-gradient(90deg, rgba(255, 23, 68, 0.25) 0%, rgba(0, 242, 254, 0.2) 100%)',
                border: '1.5px solid #ff1744',
                color: '#ffffff',
                boxShadow: '0 0 12px rgba(255, 23, 68, 0.35)'
              }}
              className="flex items-center gap-1.5 px-3.5 py-2 rounded-lg text-[10px] font-black uppercase tracking-wider hover:brightness-125 transition-all flex-shrink-0"
            >
